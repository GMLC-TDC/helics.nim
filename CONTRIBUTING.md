# Contributing to HELICS.nim and the GMLC-TDC archives
...
HELICS and HELICS.nim are distributed under the terms of the BSD-3 clause license.
...
For the time being please submit pull requests against the master branch.  
